# -*- coding: utf-8 -*-
"""
Created on Monday April 06 18:42:42 2020
...
class Database:
    ...
    def __del__(self):
        ...
        #procedure for the CRUD operations on the database
...
# input field validation rules using recursive function def validate
class Values:
...
#insertion validation using exception handling
    def Insert(self):
        self.values = Values()
...
#serch algorithm  to look for data in the database
        for record in data:
...
class HomePage:
    def __init__(self):
        ...
        self.homePageWindow.wm_title("Patient Data Bank")
        tkinter.Label(self.homePageWindow, text = "Patients Data Bank",  width = 100).grid(pady = 20, column = 1, row = 1)
#homepage buttons
